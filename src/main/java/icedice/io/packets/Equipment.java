...
public class Equipment implements Packet {
    ...
    private String[] shields = {
            ...
            "shield", "Elysian spirit shield", "Divine spirit shield", "Saradomin shield"};
    private String[] amulets = {"amulet", "necklace", "stole", "Amulet of", "Tri-jester scarf", "D'chain"};
    private String[] arrows = {"arrow", "ice arrows", "bolt", "bolts", "Ice arrows", "arrow(p++)", "arrow(p+)", "arrow(p)", "arrow(s)"};
    ...
    private String[] body = {
            ...
            "Prince tunic", "Wizard robe (g)", "Wizard robe (t)", "Runecrafter robe", "apron", "Apron", "Elite platebody", "Doctors' gown"};
    private String[] legs = {
            "platelegs", "knight robe", "plateskirt", "skirt", "bottoms", "chaps",
            "platelegs (t)", "platelegs (g)", "bottom", "skirt", "skirt (g)",
            "skirt (t)", "chaps (g)", "chaps (t)", "tassets", "legs", "Skeleton leggings", "Rogue trousers", "Flared trousers", "3rd age robe", "Saradomin legs", "Silly jester tights"};
    private String[] weapons = {
            "Seercull", "bow", "Magic longbow",
            "scimitar", "Bandos Scimitar", "Inferno", "inferno", "Inferno Adze", "inferno adze", "adze", "Adze", "cane", "wand", "Gnomecopter", "Ivandis flail (30)", "eggs", "Snowball", "halberd", "Barrelchest anchor", "claws", "longsword", "sword", "crozier", "longbow", "shortbow", "dagger",
            "mace", "halberd", "spear", "Abyssal whip", "Bandos Whip", "axe", "flail", "crossbow",
            ...
            "godsword", "c'bow", "Crystal bow", "new crystal bow", "Dark bow", "Magic butterfly net", "Ghost buster 500", "Gold bow", "Zamorak godbow", "Twin Swords", "Twin swords", "Twin sword", "Scythe", "A jester stick", "Dark Greenbow", "Dark Bluebow", "Dark Yellowbow", "Dark Whitebow", "Gold bow", "Zamorak godbow", "warhammer"};
    ...
    private String[] fullbody = {
            ...
            "chestplate", "torso", "chainbody", "Varrock armour", "Guthix d'hide", "Saradomin d'hide", "Prince tunic", "Wizard robe (g)", "Wizard robe (t)", "Runecrafter robe", "Saradomin plate"};
    ...
    private String[] fullhat = {
            ...
            "Helm of neitiznot", "Statius's full"};

    /* Fullmask covers your entire head. */
    private String[] fullmask = {
            "full helm", "mask", "Mask", "Slayer helmet", "Veracs helm", "Guthans helm",
            "Torags helm", "Karils coif", "full helm (t)", "full helm (g)", "Green h'ween mask", "Red h'ween mask", "Blue h'ween mask", "full helmet", "Grim reaper hood", "Lunar helm", "Saradomin full helm", "halo helm"};
    ...
    public void handlePacket(Player p, int packetId, int packetSize) {
        ...
        if (p.items[index] == wearId) {
            ...
            if (wearId == 3140 && p.DragonSlayer != 5 || wearId == 1127 && p.DragonSlayer != 5 || wearId == 1121 && p.DragonSlayer != 5) {
                p.frames.sendMessage(p, "You must complete dragon slayer before you can wear this.");
                return;
            }

            if ((wearId == 3101) || (wearId == 1007)) {
            ...
            if (wearId == 6724 && p.Seercull != 5) {
                p.frames.sendMessage(p, "You must complete Legendary Seercull Bow quest before you can wear this.");
                return;
            }
    ...
    public int getCLRanged(int ItemID) {
        ...
        if (itemName.equals("Zamorak godbow")) {
            return 80;
        }
        if (itemName.equals("Gold bow")) {
            return 75;
        }
        if (itemName.equals("Dark greenbow")) {
            return 65;
        }
        if (itemName.equals("Dark bluebow")) {
            return 65;
        }
        if (itemName.equals("Dark whitebow")) {
            return 65;
        }
        if (itemName.equals("Dark yellowbow")) {
            return 65;
        }
    ...
    public int getCLStrength(int ItemID) {
        ...
        if (itemName.equals("Bandos Whip")) {
            return 85;
        }
    ...
    public int getCLDefence(int ItemID) {
        ...
        if (itemName.equals("iCEYYSCAPe kiteshield")) {
            return 90;
        }
        if (itemName.equals("Dragon kiteshield")) {
            return 60;
        }
        if (itemName.equals("Dragon gauntlets")) {
            return 60;
        }
        return 1;
    }
