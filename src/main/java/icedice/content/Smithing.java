...
public class Smithing {
    ...
    public void additem(Player p, int Type, int Button2) {
        switch (Button2) {
            ...
            case 23:
                ...
                p.frames.sendMessage(p, "You Made " + Engine.items.getItemName(Dagger(Type)));
                break;
            ...
            case 33:
                ...
                p.frames.sendMessage(p, "You Made " + Engine.items.getItemName(WcAxe(Type)));
                break;
            ...
            case 41:
                ...
                p.frames.sendMessage(p, "You Made " + Engine.items.getItemName(Mace(Type)));
                break;
            ...
            case 49:
                ...
                p.frames.sendMessage(p, "You Made " + Engine.items.getItemName(MedHelm(Type)));
                break;
            ...
            case 56:
            case 57:
                pi.addItem(p, Bolts(Type), 10);
                p.frames.sendMessage(p, "You Made " + Engine.items.getItemName(Bolts(Type)));
                break;

			/* case : //For normal sword
            case :
			case :
			case :
				pi.addItem(p, Sword(Type), 1);
				p.frames.sendMessage(p, "You Made " + Engine.items.getItemName( Sword(Type)));
				break; */
            ...
            case 80:
            case 81:
                pi.addItem(p, Nails(Type), 5);
                p.frames.sendMessage(p, "You Made " + Engine.items.getItemName(Nails(Type)));
                break;
            ...
            case 112:
            case 113:
                pi.addItem(p, ArrowTips(Type), 15);
                p.frames.sendMessage(p, "You Made " + Engine.items.getItemName(ArrowTips(Type)));
                break;
            ...
            case 121:
                ...
                p.frames.sendMessage(p, "You Made " + Engine.items.getItemName(Scimater(Type)));
                break;
            ...
            case 129:
                ...
                p.frames.sendMessage(p, "You Made " + Engine.items.getItemName(CbowLimbs(Type)));
                break;
            ...
            case 137:
                ...
                p.frames.sendMessage(p, "You Made " + Engine.items.getItemName(LongSword(Type)));
                break;
            ...
            case 144:
            case 145:
                pi.addItem(p, TrowingKnife(Type), 5);
                p.frames.sendMessage(p, "You Made " + Engine.items.getItemName(TrowingKnife(Type)));
                break;
            ...
            case 153:
                ...
                p.frames.sendMessage(p, "You Made " + Engine.items.getItemName(FullHelm(Type)));
                break;
            ...
            case 185:
                ...
                p.frames.sendMessage(p, "You Made " + Engine.items.getItemName(Warhammer(Type)));
                break;
            ...
            case 193:
                ...
                p.frames.sendMessage(p, "You Made " + Engine.items.getItemName((Type)));
                break;
            ...
            case 201:
                ...
                p.frames.sendMessage(p, "You Made " + Engine.items.getItemName(ChainBody(Type)));
                break;
            ...
            case 225:
                ...
                p.frames.sendMessage(p, "You Made " + Engine.items.getItemName(TwoHandedSword(Type)));
                break;
            ...
            case 233:
                ...
                p.frames.sendMessage(p, "You Made " + Engine.items.getItemName(PlateSkirt(Type)));
                break;
            ...
            case 241:
                ...
                p.frames.sendMessage(p, "You Made " + Engine.items.getItemName(PlateLegs(Type)));
                break;
            ...
            case 248:
            case 249:
                pi.addItem(p, PlateBody(Type), 1);
                p.frames.sendMessage(p, "You Made " + Engine.items.getItemName(PlateBody(Type)));
                break;

            default:
                //Misc.println("Button: " + Button2 + " Type: " + Type);
                break;
    ...
    public void EarnedXp(Player p, int Type, int button2) {
        ...
        p.addSkillXP(s1 * Config.Smithing_XP * Config.bonusXP, 13);
    }
        ...
        for (int i = 0; i < amout; i++) {
            if (p.skillLvl[13] >= lvlreq(Type, button2)) {
                if (pi.invItemCount(p, Bar(Type)) >= AmoutOfBars(button2)) {
                    ...
                    if (pi.invItemCount(p, Bar(Type)) < AmoutOfBars(button2)) {
                        log = true;
                        p.frames.sendMessage(p, "You dont got enough bars to make this item.");
                        break;
                    }
                }
            }
