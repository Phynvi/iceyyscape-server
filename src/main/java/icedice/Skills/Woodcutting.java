...
import icedice.players.items.*;  //needed
...
public class Woodcutting {
    ...
    public void startCutting(int objectid) {
        ...
        if (PlayerItems.freeSlotCount(p) < 1) {
            p.frames.sendMessage(p, "Your inventory is full.");
            return;
        }
    ...
    public int getPlayerAxe() {
        ...
        if (p.equipment[3] == 8814) return 8814;
        return -1;
    }
